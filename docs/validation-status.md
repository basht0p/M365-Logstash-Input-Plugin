...
| Plugin Ruby specs | RSpec: 14/14 passed on both Logstash 8.19.22 and 9.5.4. |
...
CI coverage for the offline packaging/install matrix on both Logstash versions is being added. The 8.19.22 offline path has not yet been verified locally.
